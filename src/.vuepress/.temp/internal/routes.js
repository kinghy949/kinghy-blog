...
export const routes = Object.fromEntries([
  ...
  ["/aitools/gemini.html", { loader: () => import(/* webpackChunkName: "aitools_gemini.html" */"D:/studySpace/kinghy-blog/src/.vuepress/.temp/pages/aitools/gemini.html.js"), meta: {"date":1767484800000,"category":["AI","tools"],"tag":["AI","工具"],"cover":"/aitools/images/gemini.png","excerpt":"\n<h2>1. 简介：为什么使用 Gemini CLI？</h2>\n<p>Gemini CLI (<code>@google/gemini-cli</code>) 是 Google 推出的开源命令行 AI 代理。它不仅是一个聊天机器人，更是一个能通过终端理解你项目上下文、读取文件甚至执行任务的开发助手。</p>\n<p><strong>主要特点：</strong></p>\n<ul>\n<li><strong>上下文感知</strong>：可以直接读取本地文件（如 <code>@main.py</code>）。</li>\n<li><strong>管道支持</strong>：可以将其他命令的输出（如 <code>git diff</code>）直接传给 Gemini。</li>\n<li><strong>多模态</strong>：支持理解代码、文本甚至某些版本中的图片。</li>\n</ul>","readingTime":{"minutes":5.71,"words":1714},"title":"Gemini CLI 完整使用教程","icon":"pen-to-square","type":"article"} }],
  ["/aitools/qoderUseFeel.html", { loader: () => import(/* webpackChunkName: "aitools_qoderUseFeel.html" */"D:/studySpace/kinghy-blog/src/.vuepress/.temp/pages/aitools/qoderUseFeel.html.js"), meta: {"date":1768003200000,"category":["AI","tools"],"tag":["AI","工具"],"cover":"/aitools/images/aitools1.png","excerpt":"<p>订阅了 Qoder 之后，我想通过这篇文章分享一些个人使用心得和感受。</p>\n<h1>Qoder 是什么</h1>\n<p><br>\nQoder（/ˈkoʊdər/）是一款面向真实软件开发的 Agentic 编码平台。通过增强上下文工程与智能体无缝结合，全面理解你的代码库，并以系统化方式推进开发任务。</p>\n<p>它提供代码智能生成、智能问答、多文件修改、编程智能体等能力，思考更深入、编码更高效、构建更出色，为开发者带来高效、流畅的编码体验。</p>\n<p>其实就是是阿里对标Cursor而打造的一款编码产品</p>\n<h2><a class=\"header-anchor\" href=\"#官网链接-https-qoder-ai\"><span>官网链接：</span></a><a href=\"https://qoder.com/referral?referral_code=bh1p27i5hGelnkvdrwCDjXzh0WaHI0FJ\" target=\"_blank\" rel=\"noopener noreferrer\">https://qoder.ai</a></h2>","readingTime":{"minutes":4.05,"words":1215},"title":"Qoder 是什么","icon":"pen-to-square","type":"article"} }],
